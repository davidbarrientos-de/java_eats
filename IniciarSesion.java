...
public class IniciarSesion extends javax.swing.JDialog {
    public void importar(){
        ...
        HashSet<String> nuevalista = lista.clientes;
    }
    ...
    private void initComponents() {
        ...
        setTitle("JavaEats - Iniciar Sesion");
        ...
        jComboBoxTipoUsuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cliente", "Administrador" }));
        ...
        jLabel3.setText("Introduzca su correo y contraseña para poder iniciar sesion.");
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        if (jComboBoxTipoUsuario.equals("Cliente")){
            try {
                if (jTextFieldCorreo.contains(nuevalista))
            }
        }
